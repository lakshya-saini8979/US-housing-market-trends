...
# ---------------------------------------------------------------------
@reactive.calc
def listings_df() -> pd.DataFrame:
    return pd.read_csv(app_dir / "listings.csv")


@reactive.calc
def list_price_df() -> pd.DataFrame:
    return pd.read_csv(app_dir / "list_price.csv")


@reactive.calc
def for_sale_df() -> pd.DataFrame:
...
# ---------------------------------------------------------------------
@reactive.calc
def listings_filtered() -> pd.DataFrame:
    return filter_by_date(listings_df(), input.date_range())


@reactive.calc
def list_price_filtered() -> pd.DataFrame:
    return filter_by_date(list_price_df(), input.date_range())


@reactive.calc
def for_sale_filtered() -> pd.DataFrame:
